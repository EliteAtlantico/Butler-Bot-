...
from . import mapping, perception
...
class VisualNavigator:
    ...
    def __init__(self, goal_label: str = perception.GOAL_LABEL,
                 ...
                 grid: mapping.OccupancyGrid | None = None, verbose: bool = False):
        ...
        self.grid = grid if grid is not None else mapping.OccupancyGrid()
    ...
    def sense(self, bot, t: float = 0.0):
        ...
        self.detections = perception.detect(self.obs, robot_yaw=bot.yaw)
    ...
    def replan(self, bot):
        ...
        cells = mapping.astar(blocked, start, goal, soft=soft)
        if cells is None:
            ...
            return False
        self._plan_failures = 0
        cells = mapping.shortcut(blocked, cells)
