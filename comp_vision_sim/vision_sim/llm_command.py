...
COMMAND_PROMPT = """You control a home robot that can drive around, look with its cameras, \
and pick up small objects it can reach.
...
{{"target": "<short name an object detector understands, e.g. keys, mug, remote control, sofa>", \
"description": "<the thing with an article, e.g. a set of keys>", \
"likely_places": ["<furniture or spot where it is usually found, most likely first, 3 to 6 of them>"], \
"reply": "<one short friendly sentence the robot says back>"}}
